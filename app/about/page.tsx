    ...
    <div className="bg-white min-h-screen font-sans">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
              ...
              through <span className="font-semibold text-amber-600">AI-driven solutions</span> and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold text-amber-600">700 impactful projects</span> using
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold text-amber-600">AI-powered</span>, scalable, and
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex justify-between items-center">
                  <h3 className="text-lg sm:text-xl font-semibold text-black">{faq.question}</h3>
                  <span>
                    {openFaq === index ? (
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-black to-amber-900 text-white">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button
            asChild
            className="inline-block px-8 py-3 bg-gradient-to-r from-yellow-700 via-yellow-600 to-yellow-500 hover:from-yellow-800 hover:via-yellow-700 hover:to-yellow-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
          >
