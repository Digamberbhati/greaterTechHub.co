      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <Button
            asChild
            size="lg"
            className="bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 hover:opacity-90 text-white px-8 py-4 text-lg font-semibold rounded-full"
          >
            ...
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-md bg-white">
                <CardContent className="p-6 text-center">
                  <div className="inline-flex p-3 mb-4 bg-blue-500/30 backdrop-blur-md rounded-xl">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 justify-center text-center">
            {technologies.map((tech, index) => (
              <span key={index} className="text-sm text-blue-900 font-medium">
                {tech.name}
              </span>
            ))}
          </div>
            ...
            {developmentSteps.map((step, index) => (
              <Card key={index} className="border-0 shadow-md bg-white">
                <CardContent className="p-6 flex items-start space-x-4">
                  <div className="p-3 bg-blue-500/30 backdrop-blur-md rounded-xl">
